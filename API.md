...
For Ambience Forge 0.1.0-rc.1:

```js
api.version; // "1.0"
api.getModuleVersion(); // "0.1.0-rc.1"
...
## Compatibility promise for API v1.0

During the 0.1.0 release-candidate cycle, the module feature set is frozen. Public API v1.0 is treated as an integration contract. If a future release requires an incompatible public API change, it should expose a new API version or capability rather than silently changing the meaning of the documented v1.0 methods.
