...
test("public API keeps the agreed integration surface", () => {
  for (const method of [
    ...
    "requestAmbience", "releaseAmbience", "setMasterVolume", "setTrackVolume", "setTrackIntensity", "previewAudio", "previewLoop", "previewRandom", "previewSequence", "previewIntensity", "setPreviewIntensity", "stopPreview", "stopAll"
  ]) {
