...
import { registerSceneControls } from "../scripts/ui/scene-controls-alpha9.js";

const controlsSource = fs.readFileSync(new URL("../scripts/ui/scene-controls-alpha9.js", import.meta.url), "utf8");
